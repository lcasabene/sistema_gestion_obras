...
// Se excluye el tipo 'ANTICIPO' del cálculo de avance físico.
$sql = "
  SELECT 
    ...
    -- DATOS REALES
    -- Total Pagado (Incluye todo lo aprobado, incluso anticipos, porque es dinero)
                ...
                <table id="tablaObras" class="table table-hover align-middle mb-0 table-vcenter" style="font-size: 0.95rem; width:100%">
                    ...
                    <tbody>
                        <?php foreach($obras as $o): 
                            ...
                            if(empty($tooltipDetalle)) $tooltipDetalle = "Sin avance físico";
                        ?>
                        <tr>
                            <td>
