    ...
    <div class="tab-content pt-3">
      ...
      <div class="tab-pane fade" id="tab_tecnico" role="tabpanel">
        <div class="row g-3">
            ...
            <div class="col-md-3"><label class="form-label small fw-bold text-danger"><i class="bi bi-geo-alt"></i> Latitud</label><input type="text" name="latitud" class="form-control" value="<?= $obra['latitud'] ?>" placeholder="-38.95..."></div>
            <div class="col-md-3"><label class="form-label small fw-bold text-danger"><i class="bi bi-geo-alt"></i> Longitud</label><input type="text" name="longitud" class="form-control" value="<?= $obra['longitud'] ?>" placeholder="-68.06..."></div>
