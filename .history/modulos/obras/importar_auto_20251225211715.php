...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Sentencia para obra_partida (basado en lo que vimos en el formulario)
        // Asumimos que la tabla se llama 'obra_partida' y tiene estas columnas
        $sqlInsertPartida = "INSERT INTO obra_partida (
                                obra_id, ejercicio, juri, sa, unor, fina, func, subf, 
