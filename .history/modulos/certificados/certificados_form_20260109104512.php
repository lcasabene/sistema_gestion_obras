...
<div class="modal fade" id="modalArca" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Seleccionar Factura</h5><button class="btn-close" data-bs-dismiss="modal"></button></div><div class="modal-body">Aquí iría el listado AJAX de facturas pendientes de la empresa.</div></div></div></div>
