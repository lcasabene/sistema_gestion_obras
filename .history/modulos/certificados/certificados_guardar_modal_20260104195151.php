...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Guardamos el % avance para Ordinario y Anticipo
        ...
        if ($cert_id == 0) {
            ...
            // Lógica para N° Certificado: Si viene vacío, calcular. Si viene lleno, usar.
        ...
        // FUENTES (Ahora siempre se reescriben para asegurar consistencia)
