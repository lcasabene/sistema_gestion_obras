...
try {
    ...
    */
    ...
    $sql = "SELECT c.id, c.fecha_emision, c.numero, c.importe_total, c.punto_venta 
    ...
    $resultado = array_map(function($f) {
        return [
            'id' => $f['id'],
            'texto' => date('d/m/Y', strtotime($f['fecha_emision'])) . " - Fac: " . str_pad($f['punto_venta'], 4, '0', STR_PAD_LEFT) . "-" . str_pad($f['numero'], 8, '0', STR_PAD_LEFT),
