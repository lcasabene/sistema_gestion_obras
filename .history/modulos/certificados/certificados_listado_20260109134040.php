...
// --- CONSULTA LISTADO ---
// Traemos datos básicos + conteo de vinculaciones
$sql = "SELECT 
            c.*, 
                ...
                <table id="tablaCertificados" class="table table-hover align-middle" style="font-size: 0.95rem;">
                    ...
                    <tbody>
                        <?php foreach($rows as $r): 
                            ...
                            // CORRECCIÓN AQUÍ: Usamos monto_neto_pagar o 0 si viene nulo
                            $montoMostrar = isset($r['monto_neto_pagar']) ? $r['monto_neto_pagar'] : 0;
                        ?>
                        <tr>
                            <td><?= $r['id'] ?></td>
