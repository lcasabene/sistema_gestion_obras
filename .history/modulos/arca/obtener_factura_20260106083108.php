...
// 3. Lógica de Búsqueda (Buscador global de DataTables)
if (!empty($_POST['search']['value'])) {
    $searchValue = $_POST['search']['value'];
    // Buscamos por Empresa (nombre_emisor), Numero o Importe
    $whereSql = " WHERE (nombre_emisor LIKE :search 
                   OR numero LIKE :search 
                   OR importe_total LIKE :search)";
