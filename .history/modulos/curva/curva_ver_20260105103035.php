            ...
            <table class="table table-bordered table-hover mb-0 table-vcenter text-center">
                <thead class="table-dark text-uppercase small">
                    <tr>
                        ...
                        <th colspan="3" class="bg-success">Básico / Anticipo</th>
                    ...
                    <tr>
                        ...
                        <th class="bg-light text-dark fw-bold text-primary">FRI</th> <th class="bg-light text-dark">Redet.</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-plan fw-bold text-dark" style="background-color: #e9ecef;"><?= fmtFri($friOriginal) ?></td>
                        ...
                        <td class="col-redet">
                            ...
                            <div class="mt-1">
                                <?php if($esAnticipo): ?>
                                    <?php if(empty($certsAnticipo)): ?><button class="btn btn-sm btn-outline-primary py-0" onclick="abrirModalNew('ANTICIPO', '<?= $per ?>', 0)">Cargar</button><?php else: ?><button class="btn btn-sm btn-link py-0" onclick="abrirModalEdit(<?= $certsAnticipo[0]['id'] ?>)"><i class="bi bi-pencil"></i></button><?php endif; ?>
                                <?php else: ?>
