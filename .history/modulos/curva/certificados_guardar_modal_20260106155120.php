...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Si viene vacio o 0, guardamos NULL. Si viene numero, guardamos int.
        //$curva_item_id = null;
        ...
        // Definir si va a basico o redet segun tipo
        $monto_basico = 0; 
        $monto_redet = 0;
        ...
        // 2. INSERT O UPDATE (Usamos bindParam con nombre :campo para mayor seguridad)
        if ($cert_id == 0) {
            // --- INSERTAR NUEVO ---
        ...
        // 3. FUENTES (Borrar y re-insertar)
