...
foreach ($itemsCurva as $i) {
    if (stripos($i['concepto'], 'anticipo') !== false) continue; 
    ...
    if ($ultimoPeriodoReal !== null && $per <= $ultimoPeriodoReal) {
        ...
        if (!in_array($per, $mesesProcesadosReal)) {
            // Unimos datos vinculados y no vinculados para el gráfico
...
<head>
    ...
    <style>
        ...
        /* Debug visual */
        .debug-id { font-size: 0.7rem; color: #666; background: #eee; border: 1px solid #ccc; width: 40px; text-align: center; display: inline-block; margin-right: 5px; }
    </style>
</head>
<body class="bg-light">
            ...
            <table class="table table-bordered table-hover mb-0 table-vcenter text-center">
                ...
                <tbody>
                    <?php foreach($itemsCurva as $item): 
                        ...
                        // FALLBACK
                        if (empty($certsBasicos) && empty($certsAnticipo) && empty($certsRedet)) {
                ...
                <div class="modal-body">
                    <div class="row mb-2">
                        <div class="col-12 text-end">
                            <small class="text-danger fw-bold me-2">DEBUG:</small>
                            <label class="small text-muted">ID Cert:</label>
                            <input type="text" name="cert_id" id="chk_modalCertId" value="0" class="debug-id" readonly title="Si editas, esto NO puede ser 0">
                            <label class="small text-muted">ID Link:</label>
                            <input type="text" name="curva_item_id" id="chk_modalCurvaItemId" value="" class="debug-id" readonly title="ID de vinculación">
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log("Sistema cargado. Versión Blindada.");
