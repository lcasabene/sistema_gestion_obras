        ...
        <div class="card shadow-sm mb-4 border-primary">
            ...
            <div class="card-body bg-light">
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4">
                        <div class="d-flex align-items-center p-2 border rounded bg-white" style="height: 38px;"> <div class="form-check form-switch w-100 mb-0">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" class="btn btn-outline-success btn-sm fw-bold" onclick="document.getElementById('csvInput').click()">
                            <i class="bi bi-filetype-csv"></i> Importar Curva CSV
                        </button>
    ...
    function procesarCSV(input) {
        ...
        lector.onload = function(e) {
            ...
            lineas.forEach(linea => {
                ...
                if (partes.length >= 2) {
                    let periodoCSV = partes[0].trim(); // Ej: 2024-05
                    let pctRaw = partes[1].trim();     // Ej: 10,5

                    // Buscamos la fila en la tabla que comience con ese periodo
                    ...
                    if (filaEncontrada) {
                        // Formateamos el porcentaje para que JS lo entienda
                        ...
                        if (!isNaN(pctFloat)) {
                            ...
                            recalcularFilaPorInput(inputPct); // Dispara cálculo
                            actualizados++;
                        }
                    }
                }
