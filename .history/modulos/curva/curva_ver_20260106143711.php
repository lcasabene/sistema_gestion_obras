...
// GRÁFICO (Temporal - usa todo lo disponible)
            ...
            <table class="table table-bordered table-hover mb-0 table-vcenter text-center">
                ...
                <tbody>
                    <?php foreach($itemsCurva as $item): 
                        ...
                        // RECUPERACIÓN DE DATOS (Prioridad: ID vinculado)
...
function resetModal(tipo, periodo, id, itemId) {
    ...
    // Debug para verificar que itemId está llegando
    console.log("Abriendo Modal. CertID:", id, " CurvaItemID:", itemId);
