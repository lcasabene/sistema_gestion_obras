    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <form method="POST" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-text small">Dejar vacío o usar el botón "Eliminar" para anular el dato.</div>
            </div>
            
            <div class="modal-footer p-1 d-flex justify-content-between">
                <button type="button" class="btn btn-outline-danger btn-sm" onclick="borrarValor()" title="Borrar dato y volver a estado pendiente">
...
<script>
  ...
  // --- 2. FUNCIONES DEL MODAL ---
    function abrirModalCarga(id, concepto, valorActual) {
        ...
        // Si valorActual es vacio, limpiar input. Si es 0, mostrar 0.
    ...
    function borrarValor() {
        // Vaciamos el input manualmente
        document.getElementById('modalValorReal').value = '';
        // Enviamos el formulario. Al ir vacío, el PHP lo convertirá a NULL.
