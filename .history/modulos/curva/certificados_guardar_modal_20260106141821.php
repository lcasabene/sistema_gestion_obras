...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // NUEVO: Capturamos el ID del ítem de curva para vincular
        ...
        // Guardamos avance también para Anticipo
        ...
        if ($cert_id == 0) {
            ...
            // Agregamos curva_item_id al INSERT
            ...
            // Agregamos curva_item_id al UPDATE
        ...
        // Si no hay versión vigente, buscamos la última asociada (esto es un fallback)
        if(!$verId){
             // Podrías redirigir al listado de certificados general si no hay curva
