    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <div class="text-muted small">
                ...
                Monto Vigente: <span class="badge bg-primary text-white" style="font-size: 0.9em;">$ <?= fmtM($cabecera['monto_original']) ?></span> |
...
new Chart(ctx, { 
    ...
    options: { 
        ...
        scales: {
            y: {
                beginAtZero: false, // CLAVE: No arrancar de 0, adaptarse al rango real
                grace: '5%'        // Margen visual arriba y abajo
            }
        },
        plugins: {
            tooltip: {
