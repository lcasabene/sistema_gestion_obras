...
if ($montoActualizado > 0) {
    $valMonto = $montoActualizado; // CORRECCIÓN: Usar el actualizado si existe
} else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['guardar_curva'])) {
    try {
        ...
        $sqlVer = "INSERT INTO curva_version (obra_id, created_at, observacion, es_vigente, monto_presupuesto, plazo_meses, mes_base) 
