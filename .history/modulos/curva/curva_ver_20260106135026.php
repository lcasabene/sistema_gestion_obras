...
foreach ($itemsCurva as $i) {
    // EXCLUSIÓN: Saltamos el anticipo del gráfico para que la curva empiece en 0 o en el primer mes de obra.
                ...
                <tbody>
                    <?php foreach($itemsCurva as $item): 
                        ...
                        if ($esPlanAnticipo) {
                            ...
                            // Redet habilitada en anticipo si hiciera falta
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Bind masks al cargar
    bindMasks();
});

// Referencia segura al Formulario
