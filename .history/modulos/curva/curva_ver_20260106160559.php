            ...
            <table class="table table-bordered table-hover mb-0 table-vcenter text-center">
                ...
                <tbody>
                    <?php foreach($itemsCurva as $item): 
                        ...
                        // LOGICA CORREGIDA: Ahora permitimos redeterminaciones en ANTICIPO si están vinculadas por ID
                        if (isset($mapaPorItemId[$itemId])) {
                            ...
                            if ($esPlanAnticipo) {
                                ...
                                // No asumimos redet vieja para anticipo para evitar duplicidad visual
                            } else {
