...
// 1. Obtener Cabecera
$sqlHead = "SELECT v.*, o.denominacion, o.monto_actualizado, o.id as obra_real_id 
...
<head>
    ...
    <style>
        ...
        .col-real { background-color: #f0fdf4; } 
                ...
                <table class="table table-bordered table-hover mb-0 table-view align-middle">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" class="bg-light">Gestión</th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr class="<?= $claseFila ?>">
                            ...
                            <td class="text-center">
                                ...
                                <?php else: ?>
                                    <?php if (!is_null($pctReal)): ?>
                                        <span class="badge bg-success bg-opacity-75"><i class="bi bi-check-lg"></i> Cargado</span>
                                    <?php else: ?>
                                        <a href="../certificados/certificados_form.php?obra_id=<?= $cabecera['obra_real_id'] ?>&periodo=<?= date('Y-m', strtotime($i['periodo'])) ?>" 
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <form method="POST" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-text small">Dejar vacío o pulsar "Eliminar" para borrar.</div>
            </div>
            
            <div class="modal-footer p-1 d-flex justify-content-between">
                <button type="button" class="btn btn-outline-danger btn-sm" onclick="borrarValor()" title="Borrar dato">
...
<script>
    ...
    function abrirModalCarga(id, concepto, valorActual) {
        ...
        document.getElementById('modalValorReal').value = (valorActual !== '' && valorActual !== null) ? valorActual : '';
        new bootstrap.Modal(document.getElementById('modalCarga')).show();
    }

    function borrarValor() {
        document.getElementById('modalValorReal').value = '';
        document.querySelector('#modalCarga form').submit();
    }
</script>
</body>
</html>