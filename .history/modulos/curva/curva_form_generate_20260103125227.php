...
// 3. (NUEVO) Cargar Vedas Invernales
// Buscamos solo los eventos de tipo VEDA_INVERNAL activos para esta obra
...
$vedasJson = json_encode($vedasRaw); // Lo convertimos a JSON para pasarlo a Javascript
...
<head>
    ...
    <style>
        ...
        .fila-veda { background-color: #e2e3e5 !important; }
        .texto-veda { color: #6c757d !important; font-style: italic; }
    </style>
</head>
<body class="bg-light">
...
<script>
    ...
    const vedasGlobales = <?= $vedasJson ?>; // Aquí están las vedas cargadas
    ...
    function generarGrillaBase() {
        ...
        // 3. OBTENER PESOS SOLO PARA MESES ACTIVOS
        // Si hay 12 meses de plazo pero 3 son veda, generamos la curva para 9 meses
        ...
        mapaMeses.forEach((m, index) => {
            ...
            let concepto = 'Certificado Nº ' + nroCert;
            let pctDelMes = 0;
            ...
            if(m.esVeda) {
                ...
                // Es Trabajable: Asignamos el siguiente peso de la curva S
