...
<script>
    ...
    // CORRECCIÓN MATEMÁTICA: INCLUYE EL MES DE ANTICIPO
    function recalcularCascadaFRI() {
        ...
        filas.forEach((tr) => {
            ...
            // Inflación de la fila (visual input)
            ...
            if (tipo === 'anticipo') {
                if (usarRedetAnticipo) {
                    // CORRECCIÓN: Calcular historia hasta el mes previo Y multiplicar por el mes actual del anticipo
