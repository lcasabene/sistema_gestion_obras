            ...
            <table class="table table-bordered table-hover mb-0 table-vcenter text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-basico">
                             <?php if(!empty($certsBasicos)): foreach($certsBasicos as $cb): ?><div class="small fw-bold mb-1">$ <?= fmtM($cb['monto_basico']) ?></div><?php endforeach; elseif(!empty($certsAnticipo)): ?><div class="small fw-bold">$ <?= fmtM($certsAnticipo[0]['monto_bruto']) ?></div><?php endif; ?>
                        </td>
