...
function recalcularFuentes() {
    ...
    // El inputNeto viene de un toFixed(2), ej: "45000000.00"
    // Usamos parseFloat directo. Si usamos parseM, le quita el punto y lo convierte en 4500 millones.
    ...
    document.querySelectorAll('#containerFufi .row').forEach(row => {
        ...
        // Calculamos el monto proporcional correcto
        let monto = neto * (pct/100);
        
        // Asignamos al input visual con formato lindo
