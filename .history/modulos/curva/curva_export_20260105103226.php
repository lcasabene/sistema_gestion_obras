    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="background-color: #e9ecef; font-weight:bold;"><?= fmtFri($item['fri']) ?></td>
                <td><?= fmt($item['redeterminacion']) ?></td>
                <td style="color:red;"><?= ($item['recupero'] > 0 ? '-' : '') . fmt($item['recupero']) ?></td>
                <td style="font-weight:bold; background-color: #e2e3e5;"><?= fmt($item['neto']) ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
