...
<head>
    ...
    <style>
        ...
        .nro-cert { font-size: 0.9em; font-weight: bold; color: #198754; background: #fff; padding: 2px 6px; border-radius: 4px; border: 1px solid #c3e6cb; white-space: nowrap; }
    </style>
</head>
<body class="bg-light">
            ...
            <table class="table table-bordered table-hover mb-0 table-vcenter text-center">
                <thead class="table-dark text-uppercase small">
                    <tr>
                        ...
                        <th colspan="4" class="bg-success border-end">Certificado Básico</th>
                    ...
                    <tr>
                        ...
                        <th class="bg-success text-white small" style="width: 60px;">Nº</th>
...
function abrirModalNew(tipo, periodo, planPct) {
    ...
    // Sugerencia de Número (Solo visual, el backend calcula el siguiente)
    ...
    if(tipo==='ORDINARIO') {
        ...
        document.getElementById('inputAnticipoPct').value = 0; // Anticipo no descuenta anticipo
    }
...
function abrirModalEdit(id) {
    ...
    .then(data => {
        ...
        document.getElementById('inputNroCert').value = data.nro_certificado; // Mostrar N° Real
...
function calcDeducciones() {
    ...
    // 2. Dev. Anticipo
    // FIX: Si es tipo ANTICIPO, no descontar anticipo
    let ant = 0;
    if(tipo !== 'ANTICIPO') {
