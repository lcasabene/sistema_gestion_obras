...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (isset($_POST['curva_item_id']) && is_numeric($_POST['curva_item_id'])) {
            ...
            // SI ENTRAS AQUÍ, EL PROBLEMA ESTÁ EN EL HTML (Input Disabled o sin value)
            throw new Exception("ERROR DE DATOS: No se recibió el 'curva_item_id'. Verifique que el input en el modal NO tenga el atributo 'disabled' (use 'readonly').");
        }
