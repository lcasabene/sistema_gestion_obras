...
// --- LÓGICA DE PRELLENADO DE DATOS DESDE LA OBRA ---
// Calculamos valores por defecto basados en lo cargado en obras_form.php

// 1. Monto: Prioridad actualizado, sino original
$valMonto = ($obra['monto_actualizado'] > 0) ? $obra['monto_actualizado'] : $obra['monto_original'];

// 2. Mes Base: Si existe en obra, usarlo. Sino mes anterior.
$valMesBase = !empty($obra['periodo_base']) ? $obra['periodo_base'] : date('Y-m', strtotime('-1 month'));

// 3. Fecha Inicio: Si existe, usarla. Sino mes siguiente.
$valFechaInicio = !empty($obra['fecha_inicio']) ? $obra['fecha_inicio'] : date('Y-m-01', strtotime('+1 month'));

// 4. Plazo: Convertir días a meses (aprox 30 días)
$valPlazo = 12; // Default
...
$valAnticipoPct = (!empty($obra['anticipo_pct'])) ? $obra['anticipo_pct'] : 10;
...
<form method="POST" id="formCurvaGlobal">
    ...
    <div class="container-fluid px-4 my-4">
        ...
        <div class="card shadow-sm mb-4 border-primary">
            <div class="card-header bg-primary text-white fw-bold">1. Parámetros de Cálculo (Datos de Obra)</div>
            <div class="card-body bg-light">
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-3">
                        ...
                        <small class="text-muted" style="font-size:0.75rem">* Calculado desde <?= $obra['plazo_dias_original'] ?? 0 ?> días</small>
                    </div>
