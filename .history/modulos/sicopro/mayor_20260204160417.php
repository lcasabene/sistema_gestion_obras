 ...
 * Archivo: mayor.php
 * Versión Final: Letra grande, Tooltip Obra, Filtros Fecha y Fix SQL_BIG_SELECTS.
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // SOLUCIÓN AL ERROR MAX_JOIN_SIZE: Habilitar Big Selects en esta sesión
...
<head>
    ...
    <style>
        ...
        .table thead th { font-size: 1.1rem; background-color: #f1f4f7; }
        ...
        <div class="card-body">
            <form method="POST" class="row g-3">
                ...
                <div class="col-md-2 d-flex align-items-end gap-2">
                    <button type="submit" class="btn btn-primary flex-grow-1 shadow-sm"><i class="fas fa-search"></i> Consultar</button>
                    <a href="mayor.php" class="btn btn-secondary shadow-sm"><i class="fas fa-eraser"></i> Limpiar</a>
                </div>
            </form>
        </div>
    </div>
            ...
            <table id="tablaMayor" class="table table-striped table-hover w-100 border">
                ...
                <tbody>
                    <?php foreach ($resultados as $row):
                        ...
                        $obra_info = $row['nombre_obra'] ? "Obra: " . htmlspecialchars($row['nombre_obra']) : "Sin denominación en tabla Obras";
                    ?>
                    <tr>
                ...
                <tfoot class="table-dark fw-bold" style="font-size: 1.1rem;">
                    <tr>
                        <td colspan="5" class="text-end uppercase">Totales del Período:</td>
