 ...
 * Archivo: mayor.php
 * Versión mejorada: Letra más grande, filtros optimizados y trazabilidad completa.
 */
...
<head>
    ...
    <style>
        ...
        .btn-custom { font-size: 1rem; padding: 8px 20px; }
    </style>
</head>
<body>
        ...
        <div class="card-body">
            <form method="POST" id="formFiltros" class="row g-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="mayor.php" class="btn btn-secondary shadow-sm" title="Limpiar"><i class="fas fa-eraser"></i> Limpiar</a>
                </div>
            </form>
        </div>
    </div>
            ...
            <table id="tablaMayor" class="table table-striped table-hover w-100 border">
                ...
                <tfoot class="table-dark">
                    <tr style="font-size: 1.2rem;">
                        <td colspan="5" class="text-end text-uppercase">Totales de la Consulta:</td>
