...
<div class="container my-5">
    ...
    <div class="row g-3">
        ...
        <?php 
        // Definimos las 6 tarjetas usando las CLAVES EXACTAS que se guardan en la base de datos
        // (SICOPRO, TOTAL_ANTICIPADO, SOLICITADO, SIN_PAGO, LIQUIDACIONES, SIGUE)
        $tipos = [
            'SICOPRO'          => ['label' => 'Base SICOPRO', 'icon' => 'bi-database-fill', 'color' => 'primary'],
            'TOTAL_ANTICIPADO' => ['label' => 'Total Anticipado', 'icon' => 'bi-cash-stack', 'color' => 'success'],
            'SOLICITADO'       => ['label' => 'Solicitado (No Ant.)', 'icon' => 'bi-hourglass-split', 'color' => 'warning'],
            'SIN_PAGO'         => ['label' => 'Antic. Sin Pago', 'icon' => 'bi-exclamation-circle', 'color' => 'danger'],
        ...
        foreach($tipos as $key => $info): 
            // Buscamos en el mapa de logs usando la clave corregida (Mayúsculas)
            $existe = isset($logsMap[$key]);
            
            // Si existe, formateamos la fecha, si no, guion
            ...
            // Estilos visuales según si hay datos o no
