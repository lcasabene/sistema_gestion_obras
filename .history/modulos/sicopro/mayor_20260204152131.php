 ...
 * Archivo: mayor.php
 * Versión final: Incluye movtrti, movtrnu, filtros de fecha, unión con empresas y botón limpiar.
 */
...
<head>
    ...
    <style>
        ...
        .table-sm th { font-size: 0.75rem; text-transform: uppercase; color: #555; }
    </style>
</head>
<body>
        ...
        <div class="card-body py-2">
            <form method="POST" id="formFiltros" class="row g-2">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    <button type="submit" class="btn btn-primary btn-sm flex-grow-1 shadow-sm"><i class="fas fa-search"></i> Consultar</button>
                    <a href="mayor.php" class="btn btn-secondary btn-sm shadow-sm"><i class="fas fa-eraser"></i> Limpiar</a>
                </div>
            </form>
        </div>
    </div>
            ...
            <table id="tablaMayor" class="table table-striped table-hover table-sm w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><span class="badge bg-secondary"><?= htmlspecialchars($row['movtrti']) ?></span></td>
                        <td class="text-center fw-bold text-dark"><?= htmlspecialchars($row['movtrnu']) ?></td>
                ...
                <tfoot class="table-light fw-bold">
                    <tr>
                        <td colspan="6" class="text-end">TOTALES DEL PERÍODO:</td>
...
$(document).ready(function() {
    $('#tablaMayor').DataTable({
        ...
        buttons: [{
            ...
            footer: true,
            title: 'Mayor_SICOPRO_Cta_<?= htmlspecialchars($cta ?? "") ?>'
        }],
        language: { url: '//cdn.datatables.net/plug-ins/1.13.6/i18n/es-ES.json' },
        pageLength: 50,
        order: [] // Respeta el orden cronológico de la DB
    });
});
</script>
</body>
