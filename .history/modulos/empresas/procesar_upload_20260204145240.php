...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['archivo_csv'])) {
    ...
    if (($gestor = fopen($file['tmp_name'], "r")) !== FALSE) {
        ...
        try {
            ...
            $stmtUpdate = $pdo->prepare("UPDATE empresas SET codigo_proveedor = ? WHERE cuit = ?");
            $stmtInsert = $pdo->prepare("INSERT INTO empresas (razon_social, cuit, codigo_proveedor) VALUES (?, ?, ?)");
