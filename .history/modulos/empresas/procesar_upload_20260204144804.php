...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['archivo_csv'])) {
    ...
    if (($gestor = fopen($file['tmp_name'], "r")) !== FALSE) {
        ...
        $stmtUpdate = $pdo->prepare("UPDATE empresas SET codigo_proveedor = :codigo_proveedor WHERE cuit = :cuit");
        $stmtInsert = $pdo->prepare("INSERT INTO empresas (razon_social, cuit, codigo_proveedor) VALUES (:nombre, :cuit, :codigo_proveedor)");
