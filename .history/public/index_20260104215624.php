...
$kpi = [
  'obras_activas' => 0,
  'fecha_corte' => 'Sin datos', // Para mostrar de cuándo es la info
  // Totales Globales
  'presup_global_def' => 0,
...
try {
    // 1. Obras Activas (Sigue viniendo de la tabla 'obras' independiente del presupuesto)
    ...
    // 2. Consulta INTELIGENTE a presupuesto_ejecucion
    // Selecciona la suma de montos SOLO para la fecha_listado más reciente del año seleccionado
    $sql_presupuesto = "
        SELECT 
            MAX(fecha_listado) as ultima_fecha,
    ...
    if ($res && $res['ultima_fecha']) {
        $kpi['fecha_corte']        = $res['ultima_fecha'];
...
// Función auxiliar para porcentaje
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small">
                Estado de situación al: <span class="fw-bold text-dark"><?= $kpi['fecha_corte'] ?></span>
            </p>
        </div>
