...
if ($version_actual) {
    ...
    foreach($res as $row) {
        // Clave para comparar (pero NO usamos esto como índice del array para evitar sobrescribir)
...
$(document).ready(function() {
    ...
    var table = $('#tablaPresupuesto').DataTable({
        ...
        buttons: [
            // Nota: El Excel exportará lo visible. Si quieres que exporte CPN, hay que cambiar config.
        ...
        // AQUÍ ESTÁ LA MAGIA PARA OCULTAR COLUMNAS
        columnDefs: [
            {
                targets: [7, 8, 9], // Índices de CPN1, CPN2, CPN3
                visible: false,     // No se ven
                searchable: true    // SÍ se buscan
            }
        ]
    });
