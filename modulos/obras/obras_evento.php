...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        if (isset($_POST['accion']) && $_POST['accion'] === 'borrar') {
            ...
            $sqlIns = "INSERT INTO obra_eventos (obra_id, tipo_evento, fecha, fecha_fin, dias_plazo, monto, acto_admin, observacion, activo) 
...
$sqlEvt = "SELECT * FROM obra_eventos WHERE obra_id = ? ORDER BY fecha ASC";
...
<div class="container my-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="obras_listado.php" class="btn btn-outline-secondary">
